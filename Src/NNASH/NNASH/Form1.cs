...
namespace NNASH
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Shown(object sender, EventArgs e)
        {
            ...
            string readText = DecryptFiles(path + ".encrypted", "tybtrybrtyertu50727885").Replace("file:///C:/nnash/", folderpath);
...
".Replace("\r\n", " ").Replace("apikeytxt", apikeytxt);
        ...
        void WebView_JSDownloadAudio(object sender, JSExtInvokeArgs e)
        {
            ...
            if (!File.Exists(path))
                SaveImage(url, path, ImageFormat.Jpeg);
            File.WriteAllText("dla.cmd", @"youtube-dl --extract-audio --audio-format mp3 " + videoid);
        ...
        void WebView_JSDownloadVideo(object sender, JSExtInvokeArgs e)
        {
            ...
            if (!File.Exists(path))
                SaveImage(url, path, ImageFormat.Jpeg);
            File.WriteAllText("dlv.cmd", @"youtube-dl --format best " + videoid);
